...
(function (T) {
  ...
  T.NPC_SPECIES = [
    ...
    { id: 'scuttler', name: 'Scuttler', level: 'omnivore', archetype: 'scavenger', startPop: 25,
      ...
      genome: { size: 2, diet: 5, repro: 3, metabolism: 'ecto', limbs: 6, tail: 0 }, flags: { skittish: true, scavenger: true, follower: 'predator' },
      behavior: 'Scavenges kills, trailing predators that do not hunt it; flees everything else.', weakness: 'Low speed, predictable routes.' },
    { id: 'thornback', name: 'Thornback', level: 'omnivore', archetype: 'armored-forager', startPop: 15,
      ...
      genome: { size: 5, diet: 4, spines: 3, armor: 1, repro: 6, metabolism: 'ecto', boldness: 0.9, tail: 3 }, flags: { follower: 'grazer' },
      behavior: 'Spined; costly to attack. Trails Tuskbeasts for the prey they flush.', weakness: 'Poor senses; easy to ambush.' },
